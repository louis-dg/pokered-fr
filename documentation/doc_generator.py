...
docFile.write("Ceci est la documentation associée à la hack rom Pokémon Rouge créée par louis-dg.\n\n")
docFile.write("Page du projet : https://github.com/louis-dg/pokered-fr\n\n")
