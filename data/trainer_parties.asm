...
; Route 20
	db $FF,35,TENTACOOL,33,HORSEA,35,SEEL,0
PokemaniacData:
; Route 10
...
; Route 21
	db $FF,39,SEAKING,40,POLIWRATH,0
    db 37,SHELLDER,CLOYSTER,0
    db $FF,20,MAGIKARP,40,GYARADOS,0
