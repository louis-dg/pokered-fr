...
; Route 25
	...
	db $FF,13,ODDISH,15,PIDGEY,13,BELLSPROUT,0
; SS Anne 1F Rooms
...
; Route 8
    ...
    db $FF,19,PIDGEY,20,RATTATA,20,NIDORAN_M,21,MEOWTH,22,PIKACHU,0
...
; Route 13
	db $FF,24,PIDGEY,21,MEOWTH,25,RATTATA,22,PIKACHU,24,EEVEE,0
    db $FF,32,POLIWHIRL,30,PSYDUCK,0
    db 27,PIDGEY,PERSIAN,PIDGEOTTO,0
...
; Rock Tunnel 1F
    ...
    db 19,PIDGEY,CUBONE,BELLSPROUT,0
; Route 15
	db 30,GLOOM,WEEPINBELL,NIDORINA,0
    db $FF,29,PIKACHU,31,RAICHU,0
    db 33,CLEFABLE,0
    db 32,BELLSPROUT,ODDISH,TANGELA,0
; Route 20
	db $FF,30,TENTACOOL,32,HORSEA,34,SEEL,0
PokemaniacData:
; Route 10
...
; Rock Tunnel B1F
	...
	db 28,SLOWPOKE,0
; Victory Road 2F
	db $FF,40,CHARMELEON,43,LAPRAS,45,LICKITUNG,0
; Rock Tunnel 1F
...
; Route 8
	db $FF,20,VOLTORB,22,KOFFING,20,MAGNEMITE,0
    db 22,GRIMER,MUK,0
...
; Route 9/Rock Tunnel B1F
	db 21,MACHOP,ONIX,0
; Rock Tunnel 1F
	db 19,GEODUDE,MACHOP,DIGLETT,MACHOKE,0
...
; Route 15
	db $FF,25,KOFFING,27,GRIMER,25,WEEZING,26,28,MUK,0
    db 29,KOFFING,GRIMER,WEEZING,0
; Route 16
	db 30,GRIMER,MUK,0
    db 36,WEEZING,0
...
; Route 17
	...
	db 33,MUK,0
	db 29,TAUROS,VOLTORB,0
	db 29,WEEZING,MUK,0
	db 25,KOFFING,WEEZING,ONIX,RHYHORN,WEEZING,0
; Route 14
	db 28,KOFFING,MUK,GRIMER,0
    db 28,GRIMER,POLIWRATH,KOFFING,0
    db 31,FLAREON,MUK,0
BurglarData:
; Unused
...
; Route 21
	db $FF,28,SEAKING,28,GOLDEEN,30,POLIWHIRL,27,GYARADOS,0
    db 34,SHELLDER,CLOYSTER,0
    db $FF,20,MAGIKARP,30,GYARADOS,28,VAPOREON,0
...
; Route 19
	...
	db 30,POLIWAG,POLIWHIRL,POLIWRATH,0
    db $FF,27,HORSEA,29,TENTACRUEL,27,TENTACOOL,30,GOLDEEN,0
    db 30,GOLDEEN,SHELLDER,WARTORTLE,0
    db 33,HORSEA,TENTACRUEL,0
    db $FF,27,TENTACOOL,28,STARYU,29,HORSEA,30,TENTACRUEL,0
; Route 20
	db 34,SHELLDER,CLOYSTER,0
    db 35,LAPRAS,0
    db $FF,28,OMANYTE,29,HORSEA,30,SEADRA,31,GYARADOS,0
; Route 21
...
; Route 8
	db 22,POLIWAG,HORSEA,POLIWHIRL,0
; Unused
...
; Route 19
	db $FF,27,POLIWAG,29,GOLDEEN,27,SEAKING,30,GOLDEEN,28,POLIWHIRL,0
    db 33,GOLDEEN,SEAKING,0
    db $FF,29,STARYU,30,SLOWPOKE,31,STARMIE,0
; Route 20
	db $FF,30,KRABBY,30,HORSEA,33,SEADRA,0
PsychicData:
; Saffron Gym
...
; Victory Road 2F
	db $FF,43,DROWZEE,45,HYPNO,41,KADABRA,44,JYNX,0
; Fuchsia Gym
	db $FF,31,SLOWBRO,32,DROWZEE,32,KADABRA,34,GOLDUCK,0
...
; Route 13
    ...
    db 26,SPEAROW,PIDGEY,SPEAROW,0
    db 28,PIDGEY,PIDGEOTTO,SPEAROW,FEAROW,0
; Route 14
	db 37,FARFETCHD,0
    db 31,SPEAROW,FEAROW,0
; Route 15
	db 28,PIDGEOTTO,FARFETCHD,DODUO,PIDGEY,0
    db 30,DODRIO,DODUO,0
; Route 18
	db 31,SPEAROW,FEAROW,0
    db 37,DODRIO,0
    db 27,SPEAROW,FEAROW,PIDGEOT,0
; Route 20
	db 32,FEAROW,FARFETCHD,PIDGEOTTO,0
; Unused
...
; Silph Co. 4F
	db 35,ELECTRODE,0
; Silph Co. 5F
	db 28,MAGNETON,KOFFING,WEEZING,MAGNEMITE,0
; Silph Co. 6F
...
GiovanniData:
; Rocket Hideout B4F
	db $FF,28,ONIX,27,RHYHORN,31,KANGASKHAN,0
; Silph Co. 11F
...
; Route 24
	db 15,EKANS,ZUBAT,0
; Game Corner
	db 21,RATICATE,ZUBAT,0
; Rocket Hideout B1F
	db 22,DROWZEE,MACHOP,0
    db 23,RATICATE,RATICATE,0
    db 20,GRIMER,KOFFING,0
    db $FF,18,RATTATA,18,RATICATE,19,NIDORINO,19,NIDORINA,0
    db 23,GRIMER,KOFFING,0
; Rocket Hideout B2F
	db $FF,18,ZUBAT,19,KOFFING,18,GRIMER,19,MANKEY,18,RATICATE,0
; Rocket Hideout B3F
	db 20,RATTATA,RATICATE,DROWZEE,0
	db 22,MACHOP,MANKEY,0
; Rocket Hideout B4F
	db $FF,23,SANDSHREW,22,EKANS,23,SANDSLASH,0
    db 24,EKANS,SANDSHREW,ARBOK,0
	db 21,KOFFING,ZUBAT,0
; Pokémon Tower 7F
	db 27,ZUBAT,ZUBAT,GOLBAT,0
    db 28,KOFFING,DROWZEE,0
    db $FF,24,ZUBAT,24,RATTATA,25,RATICATE,23,ZUBAT,0
; Unused
	db 27,DROWZEE,KOFFING,0
; Silph Co. 2F
	db 31,CUBONE,ZUBAT,0
    db $FF,25,GOLBAT,24,ZUBAT,24,ZUBAT,27,RATICATE,27,POLIWHIRL,0
; Silph Co. 3F
	db 30,RATICATE,HYPNO,RATICATE,0
; Silph Co. 4F
	db 31,MACHOP,DROWZEE,0
    db $FF,29,EKANS,28,ZUBAT,29,CUBONE,0
; Silph Co. 5F
	db 36,ARBOK,0
    db 36,HYPNO,0
; Silph Co. 6F
...
; Silph Co. 7F
	db $FF,26,RATICATE,26,ARBOK,27,KOFFING,27,GOLBAT,0
    db 29,CUBONE,GRAVELER,0
    db 31,SANDSHREW,SANDSLASH,0
; Silph Co. 8F
	db $FF,27,RATICATE,27,ZUBAT,28,GOLBAT,28,RATTATA,0
    db 30,WEEZING,GOLBAT,KOFFING,0
; Silph Co. 9F
	db 30,MACHOP,TAUROS,0
    db 30,GOLBAT,DROWZEE,HYPNO,0
; Silph Co. 10F
	db 36,MACHOKE,0
; Silph Co. 11F
	db $FF,25,RATTATA,25,RATTATA,26,ZUBAT,27,CUBONE,27,EKANS,0
...
BrunoData:
	db $FF,57,ONIX,59,HITMONCHAN,59,HITMONLEE,60,ONIX,62,MACHAMP,0
BrockData:
...
Green2Data:
; SS Anne 2F
	db $FF,19,PIDGEOTTO,17,RATICATE,19,KADABRA,20,WARTORTLE,0
    db $FF,19,PIDGEOTTO,17,RATICATE,19,KADABRA,20,IVYSAUR,0
    db $FF,19,PIDGEOTTO,17,RATICATE,19,KADABRA,20,CHARMELEON,0
; Pokémon Tower 2F
...
; Silph Co. 7F
	db $FF,40,PIDGEOT,41,GROWLITHE,38,EXEGGCUTE,38,ALAKAZAM,43,BLASTOISE,0
    db $FF,40,PIDGEOT,41,GYARADOS,38,GROWLITHE,38,ALAKAZAM,43,VENUSAUR,0
    db $FF,40,PIDGEOT,41,EXEGGCUTE,38,GYARADOS,38,ALAKAZAM,43,CHARIZARD,0
; Route 22
	db $FF,50,PIDGEOT,48,RHYHORN,49,GROWLITHE,51,EXEGGCUTE,53,ALAKAZAM,57,BLASTOISE,0
    db $FF,50,PIDGEOT,48,RHYHORN,49,GYARADOS,51,GROWLITHE,53,ALAKAZAM,57,VENUSAUR,0
    db $FF,50,PIDGEOT,48,RHYHORN,49,EXEGGCUTE,51,GYARADOS,53,ALAKAZAM,57,CHARIZARD,0
Green3Data:
	db $FF,65,PIDGEOT,63,ALAKAZAM,64,RHYDON,64,ARCANINE,67,EXEGGUTOR,70,BLASTOISE,0
	db $FF,65,PIDGEOT,63,ALAKAZAM,64,RHYDON,64,GYARADOS,67,ARCANINE,70,VENUSAUR,0
	db $FF,65,PIDGEOT,63,ALAKAZAM,64,RHYDON,64,EXEGGUTOR,67,GYARADOS,70,CHARIZARD,0
LoreleiData:
	db $FF,58,DEWGONG,57,CLOYSTER,58,SLOWBRO,60,JYNX,60,LAPRAS,0
ChannelerData:
; Unused
	db 22,GASTLY,0
	db 24,GASTLY,0
...
AgathaData:
	db $FF,60,GENGAR,60,GOLBAT,59,HAUNTER,62,ARBOK,64,GENGAR,0
LanceData:
	db $FF,62,GYARADOS,60,DRAGONAIR,60,DRAGONAIR,64,AERODACTYL,66,DRAGONITE,0
