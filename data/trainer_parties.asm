...
; Rock Tunnel B1F
	...
	db 28,SLOWPOKE,0
; Victory Road 2F
	db $FF,45,CHARMELEON,43,LAPRAS,45,SCYTHER,0
; Rock Tunnel 1F
...
; Cinnabar Gym
    ...
    db $FF,36,PONYTA,37,CHARMANDER,38,VULPIX,40,GROWLITHE,0
    db 43,RAPIDASH,NINETALES,0
...
; Mansion 3F
	db 41,NINETALES,0
; Mansion B1F
	db 40,GROWLITHE,PONYTA,MAGMAR,0
EngineerData:
; Unused
...
; Route 21
	db $FF,42,SEAKING,43,POLIWRATH,0
...
; Route 19
	db 36,SHELLDER,TENTACRUEL,0
	db 35,GOLDEEN,HORSEA,STARYU,0
	db 34,POLIWAG,POLIWHIRL,POLIWRATH,0
    db $FF,35,HORSEA,TENTACOOL,TENTACRUEL,0
    db 35,GOLDEEN,SHELLDER,WARTORTLE,0
    db 36,HORSEA,SEADRA,0
    db $FF,34,STARYU,36,HORSEA,38,TENTACRUEL,0
; Route 20
...
; Route 21
    ...
    db 43,STARMIE,POLIWHIRL,0
    db 41,STARYU,WARTORTLE,0
    db 40,POLIWHIRL,TENTACOOL,SEADRA,0
CueBallData:
; Route 16
...
; Route 19
	db $FF,34,POLIWAG,35,SEAKING,36,GOLDEEN,37,POLIWHIRL,0
    db 37,GOLDEEN,SEAKING,0
    db $FF,36,STARYU,34,SLOWPOKE,35,STARMIE,0
; Route 20
	db $FF,38,KRABBY,KINGLER,0
PsychicData:
; Saffron Gym
...
; Victory Road 2F
	db 47,PERSIAN,GOLDUCK,PINSIR,0
; Unused
...
; Route 18
    ...
    db 38,DODRIO,0
    db 32,FEAROW,PIDGEOT,0
; Route 20
	db 40,FARFETCHD,FEAROW,0
; Unused
...
; Viridian Gym
    ...
    db 45,MACHAMP,0
    db 41,MACHOKE,HITMONCHAN,POLIWRATH,0
; Victory Road 2F
	db 46,MACHOKE,HITMONLEE,PRIMEAPE,0
Green1Data:
	db 5,SQUIRTLE,0
	db 5,BULBASAUR,0
	db 5,CHARMANDER,0
...
; Rocket Hideout B1F
    ...
    db $FF,25,RATICATE,24,NIDORINO,24,NIDORINA,0
    db 25,DROWZEE,KOFFING,0
; Rocket Hideout B2F
	db $FF,23,ZUBAT,23,KOFFING,24,GRIMER,0
; Rocket Hideout B3F
	db 23,RATICATE,DROWZEE,0
	db 24,MACHOP,MANKEY,0
; Rocket Hideout B4F
	db $FF,24,SANDSHREW,24,EKANS,26,SANDSLASH,0
    db $FF,24,EKANS,24,SANDSHREW,26,ARBOK,0
	db 26,MUK,0
; Pokémon Tower 7F
...
; Silph Co. 4F
    ...
    db $FF,30,EKANS,30,ZUBAT,32,GOLBAT,0
; Silph Co. 5F
	db 36,ARBOK,0
    db 36,HYPNO,0
; Silph Co. 6F
...
; Silph Co. 7F
    ...
    db 33,CUBONE,GRAVELER,0 ; un des 4 freres rockets
...
; Silph Co. 10F
	db 36,MACHOKE,0
; Silph Co. 11F
	db $FF,30,RATTATA,33,MUK,33,ARBOK,0
    db $FF,32,CUBONE,32,DROWZEE,35,MAROWAK,0
CooltrainerMData:
; Viridian Gym
	db 41,NIDOQUEEN,NIDOKING,0
; Victory Road 3F
...
; Silph Co. 7F
	db $FF,39,PIDGEOT,38,GROWLITHE,37,EXEGGCUTE,37,ALAKAZAM,40,BLASTOISE,0
    db $FF,39,PIDGEOT,38,GYARADOS,37,GROWLITHE,37,ALAKAZAM,40,VENUSAUR,0
    db $FF,39,PIDGEOT,38,EXEGGCUTE,37,GYARADOS,37,ALAKAZAM,40,CHARIZARD,0
; Route 22
